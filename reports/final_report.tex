...
\author{Independent Quantitative Research Project}
\date{2026年5月}
...
\resizebox{\linewidth}{!}{\input{tables/prediction_metrics_all.tex}}
\end{table}
...
\label{tab:backtest}
\resizebox{\linewidth}{!}{\input{tables/model_comparison_metrics.tex}}
\end{table}
...
\resizebox{\linewidth}{!}{\input{tables/cost_sensitivity.tex}}
\end{table}
...
\resizebox{\linewidth}{!}{\input{tables/holding_period_sensitivity.tex}}
\end{table}
